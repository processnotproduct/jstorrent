...
var port = {
    postMessage: function(data) {
        console.log('port.postMessage w data',data);
...
function show_debug(str) {
    if (debug)
        console.log.bind(console, 'content:')(str);
}
...
function content_onMessage(request) {
    console.log("--content_onMessage");
        show_debug(request);
        if (request.func == 'init_list') {
            init_list();
        } else if (request.func == 'change_dir') {
            change_dir_c(request.param);
        } else if (request.func == 'change_type') {
            change_type_c(request.param);
