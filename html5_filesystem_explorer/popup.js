...
function show_debug(str) {
    if (debug)
        console.log.bind(console, 'popup:')(str);
}
...
/*
        a.addEventListener('click', function() {
            ...
            //filesystem_window = chrome.app.window.create(node.path,
//                                                   { defaultWidth: 500,
//                                                     id:'media',
//                                                     minHeight: 500,
//                                                     defaultHeight: 500 }
...
function busy_count_down() {
    ...
    if (busyCount == 0) {
        ...
        if (finishedRequestCallback) {
            console.warn('finishedRequestCallback');
            finishedRequestCallback();
        } else {
            console.warn('finishedReqCallback is null');
        }
    }
}
...
function popup_onMessage(request, sender, sendResponse) {
    console.log("--popup_onMessage");
    ...
    // show the size of storage use
        ...
        show_debug('request finished; busy--');
        busy_count_down();
    }
    else {
